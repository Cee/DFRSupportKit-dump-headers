...
@property(readonly) NSImage *zoomBackInDFRImage;
@property(readonly) NSImage *warningNavigatorDFRImage;
...
@property(readonly) NSImage *snapToFitDFRImage;
...
@property(readonly) NSImage *interfaceBuilderNavigationDFRImage;
...
@property(readonly) NSImage *goUpDFRImage;
@property(readonly) NSImage *goDownDFRImage;
...
@property(readonly) NSImage *comparisonNavigationDFRImage;
...
@property(readonly) NSImage *assetCatalogNavigationDFRImage;
